 ...
 */
final class Version20201009130447 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, number_tva VARCHAR(20) DEFAULT NULL, is_verified TINYINT(1) NOT NULL, groupclient INT NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE zone_de_marquage (id INT AUTO_INCREMENT NOT NULL, product_id_id INT NOT NULL, height VARCHAR(255) DEFAULT NULL, width VARCHAR(255) DEFAULT NULL, top VARCHAR(255) DEFAULT NULL, left_space VARCHAR(255) DEFAULT NULL, top_space VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_5762182EDE18E50B (product_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD12469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
        $this->addSql('ALTER TABLE zone_de_marquage ADD CONSTRAINT FK_5762182EDE18E50B FOREIGN KEY (product_id_id) REFERENCES product (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE zone_de_marquage DROP FOREIGN KEY FK_5762182EDE18E50B');
