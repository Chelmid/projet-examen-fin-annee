 ...
 */
final class Version20220922171224 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD groupclient INT NOT NULL, ADD adresse VARCHAR(255) NOT NULL, ADD cp INT NOT NULL, ADD ville VARCHAR(255) NOT NULL, ADD telephone INT NOT NULL, ADD pays VARCHAR(255) NOT NULL, CHANGE number_tva number_tva VARCHAR(20) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP groupclient, DROP adresse, DROP cp, DROP ville, DROP telephone, DROP pays, CHANGE number_tva number_tva VARCHAR(20) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`');
    }
}
